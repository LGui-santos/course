...
public class CourseServiceImpl implements CourseService {
    ...
    public boolean existsByCourseAndUser(UUID courseId, UUID userId) {
        return courseRepository.existsByCourseAndUserId(courseId, userId);
    }
    ...
    @Transactional
    @Override
    public void saveSubscriptionUserInCourseAndSaveNotification(CourseModel courseModel, UserModel userModel) {
